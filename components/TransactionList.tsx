        ...
        <View style={styles.container}>
            ...
            <View style={styles.list}>
                <FlashList
                    ...
                    //estimatedItemSize={60}  // not supported in latest flashlist version 
                />
            </View>
...
const TransactionItem = ({
    ...
    handleClick,
     ...
     let category = 
        ...
        item?.type?.trim() == "income" ? incomeCategory : (expenseCategories[item.category || ""] || expenseCategories.others);
